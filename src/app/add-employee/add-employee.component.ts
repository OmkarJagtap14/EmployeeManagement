...
export class AddEmployeeComponent implements OnInit {
  ...
  saveEmployee() {
    // this.employee = new Employee(this.id, this.firstname, this.lastname, this.gender, this.DOB, this.DOJ,  this.email, this.phone, this.street,this.city, this.state,this.zipCode, this.Job_title);
